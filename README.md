Note: This repo is in the update stage, there are several unresolved bugs, make sure to send an issue if you find a bug in the this repo. The documentation hasn't been updated
...
```bash
npm install luna-messenger-api
```
